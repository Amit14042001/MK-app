  ...
  if (step === 'splash') {
    return (
      <LinearGradient colors={['#1A1A2E', '#0F3460', '#E94560']} style={styles.splash}>
        ...
        <Text style={styles.splashTitle}>MK Pro</Text>
      ...
      <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
        ...
        <LinearGradient colors={['#1A1A2E', '#0F3460']} style={styles.header}>
          <View style={styles.logoRow}>
            ...
            <View>
              <Text style={styles.logoTitle}>MK Pro</Text>
          ...
          <Text style={styles.headerSub}>
            {step === 'phone'
              ? 'Join 50,000+ professionals earning on MK'
              : step === 'otp'
          ...
          {step === 'phone' && (
            <>
              ...
              <Text style={styles.disclaimer}>
                By continuing, you agree to MK's{' '}
